...
shinyUI(fluidPage(useShinyjs(),useShinyalert(),
  ...
  titlePanel("Калькулятор норм и аномалий на Кольском меридиане", windowTitle = "MMBI_NORMANO_KT2020"),
          ...
          fluidRow(column(12, radioButtons("norm_charactRB", label = "Выберите характеристику",
           ...
           fluidRow(column(12, div(style="display: inline-block; width:10px; ",p("c")),
            ...
            verticalLayout(
              ...
              #hardbass: https://stackoverflow.com/questions/39196743/interactive-directory-input-in-shiny-app-r
...
mainPanel(width = 9,
    ...
    tabsetPanel(id = "tabset",
       tabPanel("Построение аномалий",value="1",
              ...
              # fluidRow(column(12,actionButton("ano_pairTestB","Pair test button", width="100%"))),
             
              # h6("Карта обеспеченности данными для выбранного месяца"),
            br(), br(),br(),br(),  br(),br(),  br(),  br(),  br(),  br(),   br(),   br(),    br(),  br()
      )),
  
     
   tabPanel("О программе",value="2",column(12, style="background-color:#D3E4F3",
                                           column(8,includeMarkdown("helpabout.md")),column(4,tags$img(src="mmbi.png",height="100%",width="100%")))
    )
  )                
